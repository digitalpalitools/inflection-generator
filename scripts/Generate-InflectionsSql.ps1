...
"-- $tableName" | Out-Sql
"CREATE TABLE $tableName (name TEXT NOT NULL PRIMARY KEY, description TEXT NOT NULL, isgrammar INTEGER NOT NULL, isverb INTEGER NOT NULL, sinh TEXT NOT NULL, deva TEXT NOT NULL, thai TEXT NOT NULL, laoo TEXT NOT NULL, mymr TEXT NOT NULL, khmr TEXT NOT NULL, beng TEXT NOT NULL, guru TEXT NOT NULL, gujr TEXT NOT NULL, telu TEXT NOT NULL, knda TEXT NOT NULL, mlym TEXT NOT NULL, lana TEXT NOT NULL, brah TEXT NOT NULL, tibt TEXT NOT NULL, cyrl TEXT NOT NULL);" | Out-Sql
"INSERT INTO $tableName (name, description, isgrammar, isverb, sinh, deva, thai, laoo, mymr, khmr, beng, guru, gujr, telu, knda, mlym, lana, brah, tibt, cyrl)" | Out-Sql
"VALUES" | Out-Sql
($Abbreviations.Keys | Sort-Object | ForEach-Object { "  ('$($Abbreviations.$_.name)', '$($Abbreviations.$_.description)', '$($Abbreviations.$_.isgrammar)', '$($Abbreviations.$_.isverb)', '$($Abbreviations.$_.sinh)', '$($Abbreviations.$_.deva)', '$($Abbreviations.$_.thai)', '$($Abbreviations.$_.laoo)', '$($Abbreviations.$_.mymr)', '$($Abbreviations.$_.khmr)', '$($Abbreviations.$_.beng)', '$($Abbreviations.$_.guru)', '$($Abbreviations.$_.gujr)', '$($Abbreviations.$_.telu)', '$($Abbreviations.$_.knda)', '$($Abbreviations.$_.mlym)', '$($Abbreviations.$_.lana)', '$($Abbreviations.$_.brah)', '$($Abbreviations.$_.tibt)', '$($Abbreviations.$_.cyrl)')" }) -join ",`n" | Out-Sql
";" | Out-Sql
"" | Out-Sql
